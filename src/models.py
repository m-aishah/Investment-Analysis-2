...
class ProjectSchema(BaseModel):
    ...
    image_url: list[str] = Field(..., title="Image URLs", description="URLs of images related to the project")
...
class InvestmentOptionsSchema(BaseModel):
    ...
    projects_data: str = Field(..., title="Projects Data", description="List of projects data")
